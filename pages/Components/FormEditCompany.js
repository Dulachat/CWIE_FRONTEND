      ...
      <div className="w-full">
        ...
        >
          <div className="w-full">
            ...
            <Form.Item
              name="company_name"
              initialValue={dataEdit.company_name}
              rules={[{ require: true, message: "กรอกข้อมูลให้ครบ" }]}
            >
              <Input
                value={dataEdit.company_name}
          ...
          <div className="w-1/2">
            ...
            <Form.Item
              name="company_tel"
              initialValue={dataEdit.company_tel}
              rules={[{ require: true, message: "กรอกข้อมูลให้ครบ" }]}
            >
              <Input
                value={dataEdit.company_tel}
                className=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              />
            </Form.Item>
          </div>
          <div className="w-1/2">
            ...
            <Form.Item
              name="company_email"
              initialValue={dataEdit.company_email}
              rules={[{ require: true, message: "กรอกข้อมูลให้ครบ" }]}
            >
              <Input
                value={dataEdit.company_email}
                type="email"
                className=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              />
            </Form.Item>
          ...
          <div className="w-full">
            ...
            <Form.Item
              ...
              initialValue={dataEdit.company_address}
              rules={[{ require: true, message: "กรอกข้อมูลให้ครบ" }]}
            >
              <Input.TextArea
                value={dataEdit.company_address}
                style={{ height: 100 }}
              />
            </Form.Item>
          </div>
