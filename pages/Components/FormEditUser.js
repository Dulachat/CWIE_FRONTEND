...
export default function FormEditUser(props) {
    ...
    useEffect(() => {
        ...
        if (item.branchJoinUser === null) {
            ...
            setSelectChangeBranch(item.branchJoinUser.branch_name)
        }
            ...
            >
                <div className='w-full mt-2'>
                    ...
                    <label className="block mb-2 text-sm font-medium text-gray-900  dark:text-white"> Username
                        ...
                        >
                            <Input value={item.username} className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                        </Form.Item>
                    </label>
                </div>
