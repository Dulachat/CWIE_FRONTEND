...
export default function FormListStudent09() {
    ...
    useEffect(() => {
        ...
        axiosInstance.get('assessment/getScoreForm09/' + UserId)
    ...
    const columns = [

        {
            ...
            sorter: true,
            render: (_, record) => {
                return <p>{record.JoinStudent.fname_TH + " " + record.JoinStudent.lname_TH}</p>
            },
            ...
            <div>
                ...
                <header className="bg-white shadow">
                    <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8">
                        <h3 className=" text-xl font-bold  tracking-tight text-gray-900 inline">คะแนนการประเมิน IN-TP09</h3>
